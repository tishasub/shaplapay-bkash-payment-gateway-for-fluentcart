<?php
/**
 * Plugin Name: ShaplaPay Payment Gateway with bKash for FluentCart
 * Description: Accept bKash payments in FluentCart through the bKash Payment Gateway API. Independent integration by ShaplaPay.
 * Version: 1.0.4
...
define('SHAPLAPAY_BKASH_VERSION', '1.0.4');
...
add_action('admin_notices', function () {
    ...
    printf(
        ...
        esc_html__('ShaplaPay Payment Gateway with bKash needs the FluentCart plugin to be installed and active. Activate FluentCart and this notice will go away.', 'shaplapay-payment-gateway-bkash-fluentcart')
    );
});
